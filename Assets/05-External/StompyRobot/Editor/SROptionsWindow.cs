...
namespace SRDebugger.Editor
{
    ...
    public class SROptionsWindow : EditorWindow
    {
        ...
        private bool optionsUpdatedSubscribed;
        private bool srOptionsSubscribed;
        ...
        private void TrySubscribe()
        {
            ...
            {
                if (!optionsUpdatedSubscribed  && Service.Options != null)
                {
                    Service.Options.OptionsUpdated += OnOptionsUpdated;
                    optionsUpdatedSubscribed = true;
                }

                if (!srOptionsSubscribed && SROptions.Current != null)
                {
                    SROptions.Current.PropertyChanged += OnOptionsPropertyChanged;
                    srOptionsSubscribed = true;
                }
            }
        }
        ...
        private void OnDisable()
        {
            ...
            optionsUpdatedSubscribed = false;
